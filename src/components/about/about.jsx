    ...
    <section id="about">
      ...
      <div className="container__about">
        ...
        <div className="about__content">
          ...
          <p>
            I am a Self-Taught web developer specializing in ReactJS, CSS3,
            HTML5, and JavaScript. Throughout my career, I have successfully
            developed and implemented visually appealing, responsive and
            user-friendly web interfaces using these technologies.
          </p>
